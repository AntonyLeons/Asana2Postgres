...
//        FileWriter writer = new FileWriter(file, false);
        List<String> fields = new ArrayList<String>(Arrays.asList("id", "created_at", "due_on", "completed", "modified_at" , "assignee", "assignee.name", "assignee.email", "tags", "custom_fields", "custom_fields.enum_value"));
        List<String> expand = new ArrayList<String>(Arrays.asList("id", "created_at", "due_on", "completed", "modified_at", "assignee", "assignee.name", "assignee.email", "tags", "custom_fields", "custom_fields.enum_value"));
...
//        }
        ...
        while (true) {
            ...
            for (Task i : result.data) {
                ...
                String sql="UPDATE public.tickets SET \"Name\"=?,\"Notes\"=? WHERE \"ID\"="+i.id;
